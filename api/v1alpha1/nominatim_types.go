...
// NominatimSpec defines the desired state of Nominatim.
type NominatimSpec struct {
	// INSERT ADDITIONAL SPEC FIELDS - desired state of cluster
	// Important: Run "make" to regenerate code after modifying this file

	// Foo is an example field of Nominatim. Edit nominatim_types.go to remove/update
...
// Nominatim is the Schema for the nominatims API.
