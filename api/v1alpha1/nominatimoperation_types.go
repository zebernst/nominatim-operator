...
type NominatimOperationSpec struct {
	...
	// Foo is an example field of NominatimOperation. Edit nominatimoperation_types.go to remove/update
...
// NominatimOperation is the Schema for the nominatimoperations API.
